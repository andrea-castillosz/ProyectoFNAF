 ...
 * @author casti
 */
public class HiloCamAnimation extends Thread {
    ...
    public HiloCamAnimation(JPanel camaragif) {
        this.camaragif = camaragif;
    }

    public HiloCamAnimation(JPanel camaragif, JPanel ofi, JPanel povcamaras) {
        this.camaragif = camaragif;
        this.ofi = ofi;
